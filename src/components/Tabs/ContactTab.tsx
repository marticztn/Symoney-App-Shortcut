          ...
          <div className="social-simple">
            <div className="qr-card">
              ...
              <div className="qr-display-container">
                <img src="/asset/red_group.JPG" alt="小红书群" className="qr-image qr-image--redbook" loading="lazy" decoding="async" />
              </div>
            ...
            <div className="qr-card">
              ...
              <div className="qr-display-container">
                <img src="/asset/wechat_group.JPG" alt="微信群" className="qr-image qr-image--wechat" loading="lazy" decoding="async" />
              </div>
              <p>{translations.scanToJoin ?? '扫码加入群聊'}</p>
            </div>
          </div>
