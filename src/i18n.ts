...
const baseTranslations: Record<Language, Translations> = {
  ...
  'zh-tw': {
    ...
    contactTitle: '與我聯繫',
    contactIntro: '關於簡錢有任何疑問？需要幫助解決問題？歡迎通過以下任何渠道與我聯繫。我很樂意提供幫助並聽取反饋。',
    authorEmail: '電子郵件',
    ...
    wechatGroup: '微信用戶群',
    scanToJoin: '掃碼加入',
    clickToView: '點擊查看群二維碼',
    siluStep1: '訪問矽基流動官方網站。',
    siluStep2: '註冊或登入您的帳戶。',
    siluStep3New: '進入控制台，左側面板中選擇「API密鑰」，然後點擊「新建API密鑰」。',
    siluStep5: '設置使用限制和權限。',
    siluStep6: '確認並生成您的 API 密鑰。',
    siluStep7: '復制並安全保存您的 API 密鑰。',
    copyToSymoney: '打開簡錢app，進入設置 > 快速記賬 > 智能，將API密鑰粘貼到相應字段中。',
    copyToSymoneyCustom: '打開簡錢app，進入設置 > 快速記賬 > 智能 > 選擇自定義服務商，將上述三個字段的信息填入對應位置。',
    volcanicStep1: '前往火山引擎開發者平台。',
    volcanicStep2: '註冊或登錄您的開發者賬戶。',
    ...
    volcanicStep5New: '接入點名稱隨意，模型選擇「豆包」，配置選擇任一豆包版本，然後點擊「創建」。',
    volcanicStep6New: '然後復制接入點ID即可。',
  }
};
